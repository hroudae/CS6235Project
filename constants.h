...
extern const uint8_t mult_x2[256];
extern const uint8_t mult_x3[256];

// Lookups for Inverse Mix Columns
extern const uint8_t mult_x9[256];
extern const uint8_t mult_x11[256];
extern const uint8_t mult_x13[256];
extern const uint8_t mult_x14[256];
